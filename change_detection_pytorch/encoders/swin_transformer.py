...
class SwinTransEncoder(SwinTransformer, EncoderMixin):
    ...
    def load_state_dict(self, state_dict, **kwargs):
        state_dict.pop("mlp_head.bias", None)
        state_dict.pop("mlp_head.weight", None)
        super().load_state_dict(state_dict, **kwargs)


swin_trans_encoders = {
    "swin_t": {
        "encoder": SwinTransEncoder,
...
if __name__ == "__main__":
    ...
    net = swin_l(window_size=8, downscaling_factors=(2, 2, 2, 2))     # input_size / 16
